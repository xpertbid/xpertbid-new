                    ...
                    <form action="{{ route('blogs.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @error('featured_image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Upload a featured image for this blog post (optional)</div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        <h6><i class="fas fa-info-circle me-1"></i> Blog Post Guidelines</h6>
                        <ul class="mb-0">
                            <li>Use engaging titles for blog posts</li>
                            <li>Slugs are automatically generated from the title</li>
                            <li>Meta title and description help with SEO</li>
                            <li>Only published posts appear on the frontend</li>
                        </ul>
                    </div>
