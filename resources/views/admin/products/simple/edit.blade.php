...
@section('title', '@trans("edit") @trans("simple_product")')

@section('content')
<div class="container-fluid">
    <!-- Page Header -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">@trans('edit') @trans('simple_product')</h1>
        <div>
                    ...
                    <div class="col-12">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <small class="text-muted">Manage translations for different languages.</small>
                            </div>
                            <div class="card-body">
                                <div id="translationManagerContainer">
                                    <div class="text-center py-4">
                                        ...
                                        <p class="mt-2">Loading translation manager...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                $('#track_quantity').prop('checked', product.track_quantity == 1);
                
                // Display current media files
                displayCurrentMedia(product);
                
                // Load translation manager
                loadTranslationManager(productId);
            } else {
...
function loadTranslationManager(productId) {
    $.ajax({
