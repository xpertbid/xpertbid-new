...
@section('title', 'Edit Auction Product')
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary btn-block mb-2">
                            <i class="fas fa-save"></i> Update Auction Product
                        </button>
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                $('#reserve_price').val(product.reserve_price);
                $('#product_country').val(product.product_country);
...
$('#auctionProductForm').on('submit', function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                Swal.fire('Success!', 'Auction product updated successfully.', 'success')
                    .then(() => {
