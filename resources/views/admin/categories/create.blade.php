...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <h6 class="text-primary">Category Structure:</h6>
                    <ul class="small mb-0">
                        <li>Create parent categories first</li>
                        <li>Use subcategories for better organization</li>
                        <li>Set sort order for display sequence</li>
                    </ul>
                </div>
                
                <div class="mb-3">
                    <h6 class="text-primary">SEO Tips:</h6>
                    <ul class="small mb-0">
                        <li>Use descriptive category names</li>
                        <li>Write helpful descriptions</li>
                        <li>Create SEO-friendly slugs</li>
                    </ul>
                </div>
                ...
                <div class="mb-0">
                    ...
                    <ul class="small mb-0">
                        ...
                        <li>Avoid too many subcategory levels</li>
                        <li>Use featured categories for promotions</li>
                    </ul>
                </div>
            </div>
        </div>
