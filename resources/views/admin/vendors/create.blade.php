...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create Vendor</h1>
        <div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/admin/vendors" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="/admin/vendors" class="btn btn-secondary me-2">Cancel</a>
