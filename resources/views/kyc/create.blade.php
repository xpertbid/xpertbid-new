...
<head>
    ...
    <title>Create KYC - {{ ucfirst($kycType) }} - XpertBid</title>
    ...
    <div class="kyc-container">
        <div class="kyc-card">
            <div class="kyc-header">
                ...
                <p>Complete your {{ ucfirst($kycType) }} verification</p>
            </div>
            ...
            <form method="POST" action="{{ route('kyc.store') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="kyc_type" value="{{ $kycType }}">
                ...
                @if($kycType === 'vendor')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="business_address" name="business_address" 
                                  rows="3" required>{{ old('business_address') }}</textarea>
                    </div>
                ...
                @if($kycType === 'property')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="property_size" name="property_size" 
                                       value="{{ old('property_size') }}" placeholder="e.g., 1000 sq ft">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="property_ownership" name="property_ownership">
                                    ...
                                    <option value="owned" {{ old('property_ownership') == 'owned' ? 'selected' : '' }}>Owned</option>
                                    <option value="rented" {{ old('property_ownership') == 'rented' ? 'selected' : '' }}>Rented</option>
                                    <option value="leased" {{ old('property_ownership') == 'leased' ? 'selected' : '' }}>Leased</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="property_description" name="property_description" 
                                  rows="3">{{ old('property_description') }}</textarea>
                    </div>
                @endif
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="vehicle_type" name="vehicle_type">
                                    ...
                                    <option value="boat" {{ old('vehicle_type') == 'boat' ? 'selected' : '' }}>Boat</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="vehicle_make" name="vehicle_make" 
                                       value="{{ old('vehicle_make') }}" placeholder="e.g., Toyota, Honda">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="vehicle_year" name="vehicle_year" 
                                       value="{{ old('vehicle_year') }}" min="1900" max="{{ date('Y') + 1 }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="auction_type" name="auction_type">
                                    ...
                                    <option value="sealed_bid" {{ old('auction_type') == 'sealed_bid' ? 'selected' : '' }}>Sealed Bid</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="item_category" name="item_category">
                                    ...
                                    <option value="art" {{ old('item_category') == 'art' ? 'selected' : '' }}>Art & Antiques</option>
                                    <option value="jewelry" {{ old('item_category') == 'jewelry' ? 'selected' : '' }}>Jewelry</option>
                                    <option value="collectibles" {{ old('item_category') == 'collectibles' ? 'selected' : '' }}>Collectibles</option>
                                    <option value="electronics" {{ old('item_category') == 'electronics' ? 'selected' : '' }}>Electronics</option>
                                    <option value="furniture" {{ old('item_category') == 'furniture' ? 'selected' : '' }}>Furniture</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="estimated_value" name="estimated_value" 
                                       value="{{ old('estimated_value') }}" placeholder="e.g., $1000 - $5000">
                            </div>
                        </div>
                    </div>
